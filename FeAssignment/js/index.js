...
function check_continue() {
    ...
    if (check_last_known_time == null || check_last_known_time == "null") {
        check_last_known_time = 0;
    }
...
function catch_the_mole(e) {
    ...
    moles.forEach(el => el.removeEventListener('click', catch_the_mole, false));
}
...
function set_random_moles() {
    ...
    const moles_show = document.querySelectorAll('.mole_show');
    moles_show.forEach(el => el.addEventListener('click', catch_the_mole));
